    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                <h1 class="mt-4">新增貨物</h1>
                <form action="new_order.php?name={:new1}&factory={:new2}" method="post">
                    <div class="d-flex flex-column justify-content-center align-items-center mt-5" id="wrapper">
                        <div class="form-group mx-auto" style="width: 500px;">
                            <label for="formId">編號</label>
                            <input type="text" class="form-control" id="formId" name="id" placeholder="Id" required>
                        </div>

                        <div class="form-group mx-auto" style="width: 500px;">
                            <label for="formDueDate">保存期限</label>
                            <input type="text" class="form-control" id="formDueDate" name="due_date" placeholder="XXXX-XX-XX" required>
                        </div>
